function checkMonth(){
	...
	switch (parseInt(inputMonth)) {
		case 1:
			...
			break;
		case 2:
			document.getElementById('result').innerHTML = "Februrary";
			break;
		case 3:
		...
		case 12:
			...
			break;
		default:
			document.getElementById('result').innerHTML = "Invalid enrty. Please try again";
	}		
}
...
function checkSeason() {
	...
	switch(parseInt(inputMonth)){
		...
		default:
			document.getElementById('result').innerHTML = "Invalid Season";
	}
}